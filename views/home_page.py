...
class HomePage(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, command=lambda: self.choose_file('P'),
                                                        text='Add Patient')
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, command=lambda: self.choose_file('C'),
                                                        text='Add Control')
        ...
        self.textbox.insert("0.0",
                            "CTkTextbox\n\n" + "Lorem ipsum dolor site magna  erat, sed diam voluptua.\n\n" * 40)

    def open_input_dialog_event(self):
        dialog = customtkinter.CTkInputDialog(text="Choose xsl file", title="Upload")
    ...
    def choose_file(self, type):
        ...
        if file_path:
            if file_path.lower().endswith('csv'):
                ...
                print('succeed')
                # todo: 1. add to db; 2. show the data and approve? only then add to db;
            else:
